...
- $P(Y=1)$ is the probability of having cancer.

- $\beta_0$ is the intercept. 

- $\beta_1, \beta_2, \cdots, \beta_k$ are the coefficients for the explanatory variables $X_1, X_2, \cdots, X_k$ (age, tobacco, and alcohol consumption in your case). These parameter estimate will show the change in the log-odds of the outcome when the variable changes from its reference level (usually 0) to the other level. In practical terms, this parameter tells us the difference in the log-odds of the probability of having cancer.
...
**Marginal posterior of Tobacco's coefficient parameters:**
...
**Marginal posterior of Alcohol's coefficient parameters:**
...
**Marginal posterior of Age's coefficient parameters:**
