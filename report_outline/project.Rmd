...
```{r, echo=FALSE}
pp_bars_1_model_1 <- pp_check(model, type="bars", newdata = test_data)
pp_bars_2_model_1 <- pp_check(model, type="bars_grouped", group="age", newdata = test_data)
```

```{r, echo=FALSE}
# Combine the plots
grid.arrange(pp_bars_1_model_1, pp_bars_2_model_1, ncol = 2)
```
...
```{r, echo=FALSE}
pp_stat_1_model_1 <- pp_check(model, type="stat", newdata = test_data)
pp_stat_2_model_1 <- pp_check(model, type="stat_grouped", group="age", newdata = test_data)
```

```{r, echo=FALSE}
# Combine the plots
grid.arrange(pp_stat_1_model_1, pp_stat_2_model_1, ncol = 2)
```
...
```{r, echo=FALSE}
pp_dens_1_model_2 <- pp_check(model2, newdata = test_data, allow_new_levels=TRUE, sample_new_levels="gaussian")
pp_dens_2_model_2 <- pp_check(model2, type="dens_overlay_grouped", group="age", newdata = test_data, allow_new_levels=TRUE, sample_new_levels="gaussian")
```

```{r, echo=FALSE}
# Combine the plots
grid.arrange(pp_dens_1_model_2, pp_dens_2_model_2, ncol = 2)
```

The next two plots displays two bars representing the observed counts of the two outcomes, with overlaid bars from the simulated data.

```{r, echo=FALSE}
pp_bars_1_model_2 <- pp_check(model2, type="bars", newdata = test_data, allow_new_levels=TRUE, sample_new_levels="gaussian")
pp_bars_2_model_2 <- pp_check(model2, type="bars_grouped", group="age", newdata = test_data, allow_new_levels=TRUE, sample_new_levels="gaussian")
```

```{r, echo=FALSE}
# Combine the plots
grid.arrange(pp_bars_1_model_2, pp_bars_2_model_2, ncol = 2)
```

The final two plots show the observed mean statistic and a distribution of the statistic computed from the simulated data set.

```{r, echo=FALSE}
pp_stat_1_model_2 <- pp_check(model2, type="stat", newdata = test_data, allow_new_levels=TRUE, sample_new_levels="gaussian")
pp_stat_2_model_2 <- pp_check(model2, type="stat_grouped", group="age", newdata = test_data, allow_new_levels=TRUE, sample_new_levels="gaussian")
```

```{r, echo=FALSE}
# Combine the plots
grid.arrange(pp_stat_1_model_2, pp_stat_2_model_2, ncol = 2)
```
...
grid.arrange(pp_bars_1_model_2, pp_bars_2_model_2, ncol = 2)# Combine the plots
grid.arrange(pp_bars_1_model_2, pp_bars_2_model_2, ncol = 2)# Combine the plots
grid.arrange(pp_bars_1_model_2, pp_bars_2_model_2, ncol = 2)# Combine the plots
